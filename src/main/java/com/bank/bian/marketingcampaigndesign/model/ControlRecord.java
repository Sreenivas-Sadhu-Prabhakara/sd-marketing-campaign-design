package com.bank.bian.marketingcampaigndesign.model;
...
/**
 * The BIAN control record for this service domain: "Marketing Campaign Design".
 *
 ...
 * to its asset type (Marketing Campaign). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Marketing Campaign Design";
